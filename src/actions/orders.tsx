...
export async function emailOrderHistory(
  ...
  if (!user) return { message: "Check your email to view your order history and download your products." };
  ...
  if (data.error) return { error: "There was an error sending your email. Please try again." };
